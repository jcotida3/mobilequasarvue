...
import ProfileTabContact from 'src/components/Profile/ProfileTabContact.vue'
import ProfileTabStudentInformation from 'src/components/Profile/ProfileTabStudentInformation.vue'
...
const personalInfo = ref({
  ...
  lastName: 'Miras',
  socialSuffix: '...',
  fullName: 'Warren Miguel Mendoza Miras',
...
const contactInfo = ref({
  primaryAddress: 'Guadalupe',
  primaryContact: '09123124',
})
  ...
  <q-page class="profile-page">
    <div class="profile-header bg-primary text-white q-pa-md">
      <q-toolbar>
        ...
        <q-btn flat round icon="logout" to="/" />
      </q-toolbar>
    ...
    <q-tab-panels v-model="activeTab" animated class="bg-transparent">
      ...
      <q-tab-panel name="additional">
        <ProfileTabAdditional
          ...
          @update:model-value="(val) => (additionalInfo = val)"
        />
      </q-tab-panel>

      <q-tab-panel name="contact">
        <ProfileTabContact :contact-info="contactInfo" />
      </q-tab-panel>

      <q-tab-panel name="student">
        <ProfileTabStudentInformation />
      </q-tab-panel>
    </q-tab-panels>
  </q-page>
</template>
