...
// Define reactive input fields
const isEditing = ref(false)
const inputFields = ref([
  { label: 'Preferred Name', placeholder: 'Enter Preferred Name', model: 'Warren Miguel' },
  { label: 'Indigenous Group', placeholder: 'Enter Indigenous Group', model: 'Filipino' },
  { label: 'Religion', placeholder: 'Enter Religion', model: 'Roman Catholic' },
  { label: 'Gender Identity', placeholder: 'Enter Gender Identity', model: 'Male' },
  { label: 'Disability', placeholder: 'Enter Disability', model: 'None' },
])

const contactFields = ref([
  { label: 'Primary Address', placeholder: 'Enter Primary Address', model: 'Test' },
  { label: 'Primary Contact', placeholder: 'Enter Primary Contact', model: 'None' },
])
            ...
            <div class="row">
              ...
              <div class="col-8">
                <div class="row q-gutter-sm">
                  <q-radio v-model="personalInfo.sex" val="male" label="Male" color="primary" />
                  <q-radio v-model="personalInfo.sex" val="female" label="Female" color="primary" />
                  <q-radio v-model="personalInfo.sex" val="other" label="Other" color="primary" />
                </div>
              </div>
            </div>
          </q-card-section>
        ...
        <q-card>
          <q-card-section class="bg-grey-2">
            <div class="text-h6 row items-center justify-between">
              ...
              <q-icon name="edit" size="sm" color="grey-5" />
            </div>
          </q-card-section>
          <q-card-section class="q-gutter-md">
            <q-input
              ...
              <q-card-section>
                ...
                <q-expansion-item label="Notes" icon="info" expand-separator>
                  <q-list>
                    <q-item>
                      <q-item-section
                        >The computation is based on the number of units passed.</q-item-section
                      >
                    </q-item>
                    <q-item>
