    ...
    <q-card flat bordered>
      ...
      <q-card-section class="q-gutter-y-md">
        ...
        <div class="row q-col-gutter-sm">
          <q-input v-model="localData.middleName" label="Middle Name" outlined dense class="col-6" />
        ...
        <q-input v-model="localData.fullName" label="Full Name" outlined dense readonly bg-color="grey-2" />
        <q-input v-model="localData.email" label="Email" outlined dense />
        <q-select v-model="localData.shiftStatus" :options="shiftOptions" label="Civil Status" outlined dense bg-color="grey-1" />
        
        
            <q-input outlined dense v-model="localData.dateOfBirth" label="Date of Birth" bg-color="grey-1">
